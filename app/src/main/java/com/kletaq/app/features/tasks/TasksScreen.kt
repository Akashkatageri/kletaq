...
import com.kletaq.app.features.tasks.components.TaskDetailsSheet
...
fun TasksScreen(
    ...
    Column(
        ...
        // Header Section with Add Button and Habit Tracker Button
        Row(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Surface(
                    ...
                    Row(
                        ...
                        Icon(Icons.Default.Event, contentDescription = "Habit Grid", tint = PurpleAccent, modifier = Modifier.size(16.dp))
                        Spacer(modifier = Modifier.width(4.dp))
                        Text("Monthly Grid 📅", fontSize = 11.sp, fontWeight = FontWeight.Bold, color = PurpleAccent)
                    }
                }
                ...
                Button(
                    ...
                    Spacer(modifier = Modifier.width(4.dp))
                    Text(
                        text = if (selectedTab == 0) "Task" else "Note",
                        fontWeight = FontWeight.Bold,
                        fontSize = 11.sp
                    )
                }
        ...
        Column(modifier = Modifier.padding(14.dp)) {
            Row(
                ...
                Row(
                    ...
                    if (task.repeatSchedule != com.kletaq.app.domain.model.RepeatSchedule.NONE) {
                        Surface(
                            shape = RoundedCornerShape(8.dp),
            ...
            Row(
                ...
                Surface(
                    shape = CircleShape,
                    color = if (task.isDoneToday) Color(0xFF10B981) else Color.Transparent,
                    border = if (task.isDoneToday) null else BorderStroke(
                        1.5.dp,
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Text(
                        text = task.title,
                        fontSize = 14.sp,
                        fontWeight = if (task.isDoneToday) FontWeight.Normal else FontWeight.SemiBold,
                        color = if (task.isDoneToday) MaterialTheme.colorScheme.onSurfaceVariant else MaterialTheme.colorScheme.onSurface,
