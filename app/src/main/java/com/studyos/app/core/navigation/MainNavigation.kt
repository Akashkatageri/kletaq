package com.studyos.app.core.navigation
...
import com.studyos.app.features.focus.TimerScreen
import com.studyos.app.features.friends.FriendsScreen
import com.studyos.app.features.home.HomeScreen
import com.studyos.app.features.journey.JourneyScreen
import com.studyos.app.features.profile.ProfileScreen
...
fun MainNavigation() {
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.padding(innerPadding)) {
            NavHost(
                ...
                composable(Screen.Splash.route) {
                    val splashViewModel: com.studyos.app.features.splash.SplashViewModel = hiltViewModel()
                    com.studyos.app.features.splash.SplashScreen(
                        viewModel = splashViewModel,
                        onNavigateToDestination = { dest ->
                            val targetRoute = when (dest) {
                                com.studyos.app.features.splash.SplashDestination.GOOGLE_SIGN_IN -> Screen.GoogleSignIn.route
                                com.studyos.app.features.splash.SplashDestination.LEGAL -> Screen.Legal.route
                                com.studyos.app.features.splash.SplashDestination.UNIVERSITY -> Screen.UniversityOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.BRANCH -> Screen.BranchOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.SCHEME -> Screen.SchemeOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.SEMESTER -> Screen.SemesterOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.CYCLE -> Screen.CycleOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.BACKLOG -> Screen.BacklogOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.USERNAME -> Screen.UsernameOnboarding.route
                                com.studyos.app.features.splash.SplashDestination.HOME -> Screen.Home.route
                ...
                composable(Screen.GoogleSignIn.route) {
                    val authViewModel: com.studyos.app.features.auth.AuthViewModel = hiltViewModel()
                    val scope = rememberCoroutineScope()

                    com.studyos.app.features.auth.GoogleSignInScreen(
                ...
                composable(Screen.Legal.route) {
                    val legalViewModel: com.studyos.app.features.legal.LegalViewModel = hiltViewModel()
                    com.studyos.app.features.legal.LegalScreen(
                ...
                composable(Screen.DocumentViewer.route) { backStackEntry ->
                    ...
                    com.studyos.app.features.legal.DocumentViewerScreen(
                        title = title,
                ...
                navigation(
                    ...
                    composable(Screen.UniversityOnboarding.route) { backStackEntry ->
                        ...
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.UniversitySelectionScreen(
                    ...
                    composable(Screen.BranchOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.BranchSelectionScreen(
                            viewModel = onboardingViewModel,
                            onBranchCompleted = {
                    ...
                    composable(Screen.SchemeOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.SchemeSelectionScreen(
                            viewModel = onboardingViewModel,
                            onSchemeCompleted = {
                                onboardingViewModel.resetStepStates()
                    ...
                    composable(Screen.SemesterOnboarding.route) { backStackEntry ->
                        ...
                        com.studyos.app.features.onboarding.SemesterSelectionScreen(
                            viewModel = onboardingViewModel,
                            onSemesterCompleted = {
                                val nextRoute = when {
                    ...
                    composable(Screen.CycleOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.CycleSelectionScreen(
                            viewModel = onboardingViewModel,
                            onCycleCompleted = {
                                onboardingViewModel.resetStepStates()
                    ...
                    composable(Screen.BacklogOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.BacklogSelectionScreen(
                            viewModel = onboardingViewModel,
                            onBacklogsCompleted = {
                                onboardingViewModel.resetStepStates()
                    ...
                    composable(Screen.UsernameOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.UsernameScreen(
                            viewModel = onboardingViewModel,
                            onUsernameCompleted = {
                                onboardingViewModel.resetStepStates()
                    ...
                    composable(Screen.ImportSyllabusOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.ImportSyllabusScreen(
                            viewModel = onboardingViewModel,
                            onImportCompleted = {
                    ...
                    composable(Screen.ConfigureCalendarOnboarding.route) { backStackEntry ->
                        val parentEntry = remember(backStackEntry) { navController.getBackStackEntry("onboarding_graph") }
                        val onboardingViewModel: com.studyos.app.features.onboarding.OnboardingViewModel = hiltViewModel(parentEntry)
                        com.studyos.app.features.onboarding.ConfigureCalendarScreen(
                            viewModel = onboardingViewModel,
                    ...
                    composable(Screen.Welcome.route) {
                        com.studyos.app.features.onboarding.WelcomeScreen(
                ...
                composable(Screen.Lesson.route) {
                    com.studyos.app.features.lesson.LessonScreen(
                ...
                composable(Screen.AdminQuestReview.route) {
                    com.studyos.app.features.admin.AdminQuestReviewScreen(
                        questTitle = activeFocusTopic ?: "Partial Differentiation",
                        subjectName = activeFocusSubject ?: "Engineering Mathematics II",
                        semesterName = activeFocusSemester ?: "Semester 2",
                        onBackClick = { navController.popBackStack() },
                ...
                composable(Screen.Settings.route) {
                    com.studyos.app.features.settings.SettingsScreen(
                ...
                composable(Screen.Notifications.route) {
                    com.studyos.app.features.notifications.NotificationsScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }

                composable(Screen.Tasks.route) {
                    com.studyos.app.features.tasks.TasksScreen(
                ...
                composable(Screen.CreateTask.route) {
                    com.studyos.app.features.tasks.CreateTaskScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }

                composable(Screen.CreateNote.route) {
                    com.studyos.app.features.notes.CreateNoteScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }

                composable(Screen.Search.route) {
                    com.studyos.app.features.search.SearchScreen(
                        onBackClick = { navController.popBackStack() },
                ...
                composable(Screen.ActiveBacklog.route) {
                    com.studyos.app.features.settings.ActiveBacklogScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
                ...
                composable(Screen.ArchivedSemesters.route) {
                    com.studyos.app.features.settings.ArchivedSemestersScreen(
                        onBackClick = { navController.popBackStack() }
                    )
                }
            }
        ...
        if (showBottomSheet) {
            com.studyos.app.core.ui.QuickActionMenuSheet(
